...
if ( ! class_exists( 'WC_Product_Variable' ) && function_exists( 'WC' ) ) {
	require_once WC_ABSPATH . 'includes/class-wc-product-variable.php';
}

class Woo_WMS_Product_Variable extends WC_Product_Variable {
